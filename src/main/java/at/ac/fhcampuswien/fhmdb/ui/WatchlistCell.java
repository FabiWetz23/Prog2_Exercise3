...
public class WatchlistCell extends ListCell<Movie> {
    ...
    private final HBox buttonsContainer = new HBox(detailBtn, removeFromWatchlistBtn);
    ...
    public WatchlistCell() {
        ...
        HBox.setMargin(removeFromWatchlistBtn, new Insets(0, 0, 0, 10));
        ...
        removeFromWatchlistBtn.setOnAction(event -> {
            // Hier implementierst du die Logik zum Entfernen des Films aus der Watchlist
            // Zum Beispiel: removeFromWatchlist(getItem());
        });
    }
